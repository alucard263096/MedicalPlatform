 ...
 */  
 class UserMgr
 {
	...
	public function getUserByName($loginname)
	{
		...
		$sql="select * from dr_tb_user where login_id='$loginname' ";
	...
	public function changsePassword($user_id,$current_password,$new_password)
	{
		...
		$sql="update dr_tb_user set password='$new_password',updated_user=$user_id,updated_date=now() where user_id=$user_id";
		$query = $this->dbmgr->query($sql);
	...
	public function resetPassword($user_id,$password,$sysUser_id)
	{
		...
		$sql="update dr_tb_user set password='$password',updated_user=$sysUser_id,updated_date=now() where user_id=$user_id";
		$query = $this->dbmgr->query($sql);
	}
