...
--
-- Dumping data for table `dr_tb_member_comment`
--

LOCK TABLES `dr_tb_member_comment` WRITE;
/*!40000 ALTER TABLE `dr_tb_member_comment` DISABLE KEYS */;
/*!40000 ALTER TABLE `dr_tb_member_comment` ENABLE KEYS */;
UNLOCK TABLES;
