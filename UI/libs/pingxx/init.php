...
if (!function_exists('curl_init')) {
	...
	logger_mgr::logError("pingxx :'Pingpp needs the CURL PHP extension.'");
  throw new Exception('Pingpp needs the CURL PHP extension.');
}
if (!function_exists('json_decode')) {
	logger_mgr::logError("pingxx :'Pingpp needs the JSON PHP extension.'");
  throw new Exception('Pingpp needs the JSON PHP extension.');
}
if (!function_exists('mb_detect_encoding')) {
	logger_mgr::logError("pingxx :'Pingpp needs the Multibyte String PHP extension.'");
