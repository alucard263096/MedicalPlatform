 ...
 * Version:     1.6.2
 * CVS:         $Id: org_jquery.dataTables.js,v 1.1 2011/02/23 20:45:32 soonchoy Exp $
 * Description: Paginate, search and sort HTML tables
 * Author:      Allan Jardine (www.sprymedia.co.uk)
 * Created:     28/3/2008
 * Modified:    $Date: 2011/02/23 20:45:32 $ by $Author: soonchoy $
 * Language:    Javascript
...
(function($) {
	...
	$.fn.dataTable = function( oInit )
	{
		...
		function _fnPageChange ( oSettings, sAction )
		{
			...
			else if( sAction.indexOf("goto ") >= 0)
			{
				try
				{
					var index = sAction.replace("goto ","");
					var pageNo = Math.round(index/oSettings._iDisplayLength)-1;
					oSettings._iDisplayStart = pageNo*oSettings._iDisplayLength;
				}
				catch(e)
				{
